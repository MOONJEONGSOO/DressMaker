...
<body>
    ...
    <div class="humberger__menu__wrapper">
        ...
        <div class="humberger__menu__cart">
            <ul>
                ...
                <li><a href="./shoping-cart.jsp"><i class="fa fa-shopping-bag"></i> <span>${sessionScope.cart.size()}</span></a></li>
            </ul>
        </div>
        ...
        <nav class="humberger__menu__nav mobile-menu">
            <ul>
	            ...
	            <li><a href="./shoping-cart.jsp">Cart</a></li>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <nav class="header__menu">
                        <ul>
                            <li class="active"><a href="https://technext.github.io/ogani/index.html">Home</a></li>
                            <li><a href="./productList.do">dress</a>
                                <ul class="header__menu__dropdown">
                                    <li><a href="./productList.do">셀프웨딩드레스</a></li>
                                    <li><a href="./ready.jsp">하우스드레스</a></li>
        ...
        <div class="container">
            ...
            <div class="checkout__form">
                ...
                <form action="./signup.do" name="regForm" id="regForm" method="post" onsubmit="return sendit()">
                	...
                	<div class="checkout__input">
                        <p>비밀번호<span>*</span></p>
                        <input type="password" name="mpw" class="pw" id="pwd_lbl" placeholder="비밀번호를 입력해주세요" required/>
                    </div>
                	<div class="checkout__input">
                	...
                	<div class="checkout__input">
                        <p>이름<span>*</span></p>
                        <input type="text" name="mname" class="w100p" id="name_lbl" placeholder="이름을 입력해주세요" required/>
                    </div>
                	<div class="checkout__input">
                        <p>이메일<span>*</span></p>
  ...
  <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p></div>
	...
	<!-- <script type="text/javascript">
		$('#id_lbl').focusout(function(){
			let data = $('.input_id').val(); // input_id에 입력되는 값
