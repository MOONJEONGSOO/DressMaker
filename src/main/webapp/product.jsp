...
<body>
                ...
                <div class="col-lg-12 text-center">
                    <div class="breadcrumb__text">
                        ...
                        <div class="breadcrumb__option">
                            ...
                            <a href="./productList.do">셀프웨딩드레스</a>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__text">
                        ...
                        <div class="product__details__price">${product.pprice}Won</div>
                        <p>${product.pinfo}</p>
                        ...
                        <a href="./addCart.do?pnum=${product.pnum}" class="primary-btn">ADD TO CART</a>
                        <!-- <a href="#" class="heart-icon"><span class="icon_heart_alt"></span></a> -->
                        <ul>
                            <li><b>Rental Availability</b> <span>${product.prental}</span></li>
                            <li><p style="color: red;">${cfail}${addfail}</p></li>
    ...
    <section class="related-product">
        <div class="container">
            ...
            <c:forEach var="pvo" items="${productList_product}" begin="0" end="3" step="1" varStatus="status">
