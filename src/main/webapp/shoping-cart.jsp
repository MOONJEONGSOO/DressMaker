    ...
    <div class="humberger__menu__wrapper">
        ...
        <nav class="humberger__menu__nav mobile-menu">
            <ul>
	            ...
	            <li class="active"><a href="./shoping-cart.do">Cart</a></li>
                ...
                <div class="col-lg-6">
                    <nav class="header__menu">
                        <ul>
                            ...
                            <li class="active"><a href="./shoping-cart.do"><spring:message code="message.main.cart"/></a></li>
	                            ...
	                            <c:forEach var="c" items="${cart}">
	                                <tr>
	                                    ...
	                                    <td class="shoping__cart__item__close">
	                                        <span class="icon_close" onclick="javascript:location.href='./minusCart.do?pnum=${c.pnum}';"></span>
	                                    </td>
	                                </tr>
	                            	<c:set var = "total" value="${total+c.pprice}" />
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="shoping__cart__btns">
                        <!-- <a href="#" class="primary-btn cart-btn cart-btn-right"><span class="icon_loading"></span>
                            Upadate Cart</a> -->
	                            <h2 style="text-align: center;">${noCart}</h2>
                        <a href="./productList.do" class="primary-btn cart-btn" style="float: right;">CONTINUE SHOPPING</a>
                    </div>
                </div>
                <div class="col-lg-6">
                ...
                <div class="col-lg-6">
                    <div class="shoping__checkout">
                        <h5>Cart Total</h5>
                        <ul>
                            <li>Quantity<span>${sessionScope.cart.size()}</span></li>
                            <li>Total <span>${total}Won</span></li>
                        </ul>
                        <moon:cart></moon:cart>
