    ...
    <div class="humberger__menu__wrapper">
        ...
        <nav class="humberger__menu__nav mobile-menu">
            <ul>
	            ...
	            <li><a href="#">Pages</a>
	                <ul class="header__menu__dropdown">
	                    <li><a href="./product.jsp">Shop Details</a></li>
	                    <li><a href="./shoping-cart.jsp">Shoping Cart</a></li>
	                    <li><a href="./checkout.jsp">Check Out</a></li>
	                    <li><a href="./board.jsp">Blog Details</a></li>
	                </ul>
	            </li>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="header__top__left">
                            <ul>
                                <li><i class="fa fa-envelope"></i>j38317_study@naver.com</li>
                                <li>가격 협의 및 대량 문의는 메일로 부탁드립니다.</li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-7">
                    ...
                    <div class="row">
                    	...
                    	<c:forEach var="pvo" items="${productList_product}">
